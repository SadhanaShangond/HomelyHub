...
import { createAccomodation } from "../../store/Accomodation/accomodation-actions";
...
const AccomodationForm = () => {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      try {
        console.log(value);
        await dispatch(createAccomodation({
        ...
        toast.success("New Property Succesfully 😊");
      ...
      >
        ...
        <div className="property-room-container">
          <div className="property-type">
            <h4 className="property-type-header">
              Property Type
            </h4>
