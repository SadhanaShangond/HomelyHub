          ...
          <div className="myaccomodation-information col-lg-9 col-md-9">
            ...
            <div className="stay-information">
              ...
              <span className="info">
                ...
                Check Out:{accomodation.checkOut}
              </span>
            </div>
            <p className="myaccomodation-city">City :{accomodation.address.city}</p>
            <p className="myaccomodation-guest">Max no of guest : {accomodation.maximumGuest}</p>
